    ...
    <header class="app-header navbar">
      ...
      <ul class="nav navbar-nav d-md-down-none">
        <li class="nav-item px-3">
          <a class="nav-link" href="admin.php">Welcome <?php echo $username ?></a>
        </li>
      </ul>
          ...
          <ul class="nav">
            ...
            <li class="nav-title">Fitur Menu</li>
             ...
             <?php if($_SESSION['id_admin']=='A0001') { ?>
                  <a class="nav-link" href="module/admin.php">
                    <i class="nav-icon icon-people"></i>Data Admin</a>
                </li>
                 <li class="nav-item">
                  <a class="nav-link" href="module/penjual.php">
                    <i class="nav-icon icon-people"></i>Data Penjual</a>
                </li>
                 <li class="nav-item">
                  <a class="nav-link" href="module/pembeli.php">
                 ...
                 <li class="nav-item">
                  <a class="nav-link" href="module/bantuan.php">
                    <i class="nav-icon icon-speech"></i>Data Bantuan</a>
                </li>
                 <li class="nav-item">
                  <a class="nav-link" href="module/konfirmasi.php">
