...
<body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
    <header class="app-header navbar">
      ...
      <ul class="nav navbar-nav d-md-down-none">
        <li class="nav-item px-3">
          <a class="nav-link" href="pembeli.php">Selamat Datang <?php echo $username ?></a>
        </li>
        <li class="nav-item px-3">
          <a class="nav-link" href="#">Saldo Jaminan Rp <?php echo $saldo; ?></a>
        </li>
      </ul>
    ...
    <div class="app-body">
      <div class="sidebar">
       ...
       <li class="nav-item">
              <a class="nav-link" href="module/ktopup_tambah.php">
                <i class="nav-icon fa fa-money"></i>Top Up Saldo</a>
            </li>
             <li class="nav-item">
              <a class="nav-link" href="module/krekber_tambah.php">
