...
$queryDetail=mysqli_query($koneksi,"select * from pesan a join penjual b on a.id_penjual=b.id_penjual join pembeli c on a.emailpembeli=c.email where a.id_penjual=b.id_penjual and (a.id_pesan='$id_pesan' and a.emailpenjual=b.email) ");
$hasilQuery=mysqli_fetch_array($queryDetail);
$email = $hasilQuery['emailpenjual'];
