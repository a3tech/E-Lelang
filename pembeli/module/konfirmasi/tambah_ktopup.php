              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-header">
                    <i class="fa fa-edit"></i>FORM KONFIRMASI TUP UP SALDO JAMINAN BARANG LELANG</div>
                  <div class="card-body">
               ...
               <input type="hidden" name="atasnama" value="<?php echo $atasnama; ?>">
                        ...
                        <div class="controls">
                          <div class="input-group">
                            <input class="form-control" id="appendedInput" size="16" type="text" name="jenis" value="Top Up Saldo" readonly="readonly">
