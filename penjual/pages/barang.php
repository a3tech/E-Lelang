...
<div class="main">
	...
	$cari = $_POST['cari'];
	$kueribarang = mysqli_query($koneksi,"select foto_1, nama_barang, harga, kd_barang, max(tanggal_berakhir) as tanggal_berakhir from barang a join penjual b on a.id_penjual=b.id_penjual where a.status='mulai' and a.nama_barang like '%$cari%' group by tanggal_berakhir desc limit 4");
	while($barang=mysqli_fetch_array($kueribarang)){
		?>   
				...
				<figure>
					 ...
					 <img src="upload/<?php echo $barang['foto_1'];?>" alt="" />
					 </figure>
